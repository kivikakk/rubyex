...
{
  RubyClass *rb_cTrueClass = _e.gc.track(new RubyClass(_e, "TrueClass")),
	    *rb_cFalseClass = _e.gc.track(new RubyClass(_e, "FalseClass")),
	    *rb_cNilClass = _e.gc.track(new RubyClass(_e, "NilClass"));
