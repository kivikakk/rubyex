...
void RubyModule::add_method(const std::string &_name, const linked_ptr<RubyMethod> &_method)
{
  if (has_method(_name))
...
void RubyModule::def_method(const std::string &_name, const linked_ptr<RubyMethod> &_method)
{
  methods[_name] = _method;
}
...
void RubyModule::add_module_method(RubyEnvironment &_e, const std::string &_name, const linked_ptr<RubyMethod> &_method)
{
...
const linked_ptr<RubyMethod> &RubyModule::get_method(const std::string &_name) const {
  std::map< std::string, linked_ptr<RubyMethod> >::const_iterator it = methods.find(_name);
  if (it == methods.end())
